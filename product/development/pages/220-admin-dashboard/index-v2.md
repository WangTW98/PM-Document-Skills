...
- 来源主稿：`product/development/pages/220-admin-dashboard/index.md`
- 来源 Sitemap 行：
  - 生成顺序：220
  - 页面ID：M-200
  - 父页面ID：ROOT
...
- 当前输出文件：product/development/pages/220-admin-dashboard/index-v2.md
- 页面级假设 / 待确认编号规则：
...
| DashboardStats | total_revenue | number | 是 | API | 0 | E-001 | 全员可见 |
