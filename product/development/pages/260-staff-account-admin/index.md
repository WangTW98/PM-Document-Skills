...
- 当前输出文件：product/development/pages/260-staff-account-admin/index.md
...
| E-003 | 人员列表表格 | table | S-002 | 是 | 总是显示 | - | - | staff_list | PA-001 |
| E-004 | 在办案件数链接 | button | S-002 | 是 | 总是显示 | {count} | 蓝色链接 | item.case_count |  |
...
|---|---|---|---|---|---|---|---|
| PA-001 | “在办案件数”列支持点击，点击后跳转至 M-510 且自动按该专家进行过滤 | 4. 页面元素清单 | 交互下钻 | E-004 | 中 | 确认 | 更新到正式 |

### 11.2 页面待确认清单

| 待确认ID | 待确认问题 | 首次出现位置 | 影响范围 | 影响元素 / Action / API / 埋点事件 | 优先级 | 用户确认结果 | Release 处理方式 |
|---|---|---|---|---|---|---|---|
| PQ-001 | 是否需要支持“批量导入”内部员工账号？当前假设为逐个手动新增。 | 2. 页面结构 | 录入效率 | - | 低 | 确认 | 不需要 |
