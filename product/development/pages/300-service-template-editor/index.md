...
|---|---|---|---|---|---|---|---|
| PA-001 | 流程编辑器采用“线性时间轴”交互，目前暂不支持并行分支流程或复杂的决策树判断 | 2. 页面结构 | 流程复杂度 | E-003 | 高 | 确认 | 发布到正式 |

### 11.2 页面待确认清单

| 待确认ID | 待确认问题 | 首次出现位置 | 影响范围 | 影响元素 / Action / API / 埋点事件 | 优先级 | 用户确认结果 | Release 处理方式 |
|---|---|---|---|---|---|---|---|
| PQ-001 | 是否需要支持“模版版本管理”（如保留 V1/V2 同时生效）？当前假设为覆盖发布。 | 6. 交互 Action | 发布策略 | - | 中 | 确认 | 不需要，仅使用覆盖发布方式 |
