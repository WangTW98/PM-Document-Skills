...
|---|---|---|---|---|---|---|---|
| S-001 | 权益展示区 | header | 总是展示 | E-001 | 黑色/金色品牌背景 | 本地 | |
...
| E-004 | 支付方式选择 | radio | S-003 | 是 | 总是展示 | 微信支付 / 支付宝 / Apple Pay | 列表单选 | payment_method | (页面假设 PA-001：iOS 端强制优先显示 Apple Pay) |
...
|---|---|---|---|---|---|---|---|
| PA-001 | iOS 端因苹果政策要求，必须支持并优先显示 Apple Pay | 4. 页面元素清单 | 支付渠道 | E-004 | 高 | 待用户确认 | 确认为正式内容 |

### 11.2 页面待确认清单

| 待确认ID | 待确认问题 | 首次出现位置 | 影响范围 | 影响元素 / Action / API / 埋点事件 | 优先级 | 用户确认结果 | Release 处理方式 |
|---|---|---|---|---|---|---|---|
| PQ-001 | 是否需要支持“首月特惠”逻辑？ | 3. 页面布局 | 价格策略 | S-002 | 中 | 待用户确认 | MVP 暂不考虑 |
