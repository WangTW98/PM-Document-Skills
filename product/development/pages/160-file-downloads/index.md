...
|---|---|---|---|---|---|---|---|
| PA-001 | 批量下载功能通过后端异步打包为 ZIP 后通过临时链接下发，前端需处理“打包中”的加载态 | 6. 交互 Action | 批量下载 | E-005, API-002 | 中 | 待用户确认 |  |

### 11.2 页面待确认清单

| 待确认ID | 待确认问题 | 首次出现位置 | 影响范围 | 影响元素 / Action / API / 埋点事件 | 优先级 | 用户确认结果 | Release 处理方式 |
|---|---|---|---|---|---|---|---|
| PQ-001 | 官方文件是否包含“预览”功能（如直接在浏览器查看 PDF）？当前假设仅支持下载。 | 4. 页面元素清单 | 交互模式 | - | 低 | 待用户确认 |  |
