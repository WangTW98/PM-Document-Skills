...
- 来源 Sitemap 行：
  ...
  - 页面名称：销售与服务统计
  - 页面类型：深度分析列表
  - Sitemap 页面级MD文件：product/development/pages/440-sales-analytics.md
- 当前输出文件：product/development/pages/440-sales-analytics/index.md
...
| E-003 | 绩效统计表格 | table | S-002 | 是 | 有数据 | - | - | analytics_list | PA-001 |
...
|---|---|---|---|---|---|---|---|
| PA-001 | 数据统计中心非实时系统，采用 T+1 或小时级增量同步。高性能分析仅支持离线维度。 | 1.1 页面目标 | 数据时效 | - | 高 | 确认 | 发布到正式 |

### 11.2 页面待确认清单

| 待确认ID | 待确认问题 | 首次出现位置 | 影响范围 | 影响元素 / Action / API / 埋点事件 | 优先级 | 用户确认结果 | Release 处理方式 |
|---|---|---|---|---|---|---|---|
| PQ-001 | 是否需要支持“专家绩效对比图”？当前仅提供列表及预警提示。 | 2. 页面结构 | UI 深度 | - | 低 | 确认 | 不需要 |
