...
5. Load exactly one release page under `product/release/pages` and read `product/release/layout/product-layout-release.md`.
...
8. End the mock draft with `## 13. 用户补充描述` so the user can add natural-language mock content modifications before release.
