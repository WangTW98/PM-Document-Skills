...
|---|---|---|---|---|---|---|---|
| PA-001 | 协议编辑器支持基础 HTML 富文本（加粗、列表、链接、表格），不支持嵌入脚本或外部 CSS。 | 2. 页面结构 | 编辑能力 | E-004 | 高 | 待用户确认 |  |

### 11.2 页面待确认清单

| 待确认ID | 待确认问题 | 首次出现位置 | 影响范围 | 影响元素 / Action / API / 埋点事件 | 优先级 | 用户确认结果 | Release 处理方式 |
|---|---|---|---|---|---|---|---|
| PQ-001 | 当协议版本更新时，是否需要强制弹窗让所有已登录用户重新勾选“同意”？当前假设为仅在下一次敏感操作（如支付）时检查。 | 1.1 页面目标 | 业务流程 | - | 中 | 待用户确认 |  |
