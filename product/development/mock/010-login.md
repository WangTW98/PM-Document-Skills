...
|---|---|---|---|---|---|---|---|
| MA-001 | 假设协议名称为《用户协议》和《隐私政策》。 | 5. 元素内容清单 | 文案 | E-006 | 高 | 待用户确认 | 确认为正式内容 |
| MA-002 | 假设未勾选协议时点击登录按钮的提示文案为“请先勾选并同意用户协议”。 | 9. 状态文案与内容差异 | 文案 | STATE-002 | 中 | 待用户确认 | 确认为正式内容 |
| MA-003 | 假设验证码发送成功的 Toast 文案为“验证码已发送至您的手机”。 | 10. Action 可见内容映射 | 文案 | AM-001 | 中 | 待用户确认 | 确认为正式内容 |

### 12.2 Mock 待确认清单

| 待确认ID | 待确认问题 | 首次出现位置 | 影响范围 | 影响区块 / 元素 / 内容对象 | 优先级 | 用户确认结果 | Release 处理方式 |
|---|---|---|---|---|---|---|---|
| MQ-001 | 是否需要在欢迎标题下方增加一行引导文案，如“未注册手机号验证后自动创建账户”？ | 9. 状态文案与内容差异 | 文案 | E-002 | 中 | 待用户确认 | 写入正式内容 |
