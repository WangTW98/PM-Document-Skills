...
5. Load `product/release/product-sitemap-release.md`, resolve the correct `product/release/layout/product-layout-release*.md` file for the target page, and parse `Sitemap 页面生成总表`.
