...
- 来源主稿：`product/development/pages/130-service-case-list/index.md`
- 来源 Sitemap 行：
  - 生成顺序：130
  - 页面ID：U-510
  - 父页面ID：U-500
...
- 当前输出文件：product/development/pages/130-service-case-list/index-v2.md
- 页面级假设 / 待确认编号规则：
...
| S-002 | 案件数据表格 | content | 总是显示 | E-005, E-006 | 响应式表格 | API-001 |  |
...
| E-005 | 案件数据表格 | list | S-002 | 是 | 有数据 | - | 表格行样式，按“更新时间”倒序排列，资料待补案件置顶 | case_list |  |
