...
8. For each selected page, follow `skills/product-page-release/SKILL.md` and release exactly one page before updating status, including analysis and application of non-empty `用户补充描述`.
