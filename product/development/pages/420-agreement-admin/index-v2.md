...
- 来源主稿：`product/development/pages/420-agreement-admin/index.md`
- 来源 Sitemap 行：
  - 生成顺序：420
  - 页面ID：M-720
  - 父页面ID：M-700
...
- 当前输出文件：product/development/pages/420-agreement-admin/index-v2.md
- 页面级假设 / 待确认编号规则：
...
mindmap
  root((协议管理中心))
    ...
    协议编辑器 (页面/弹窗)
      ...
      更新摘要说明
      生效计划 (立即/定时，协议更新时仅在下一次敏感操作如支付时检查)
```
