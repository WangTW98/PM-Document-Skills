...
- 来源主稿：`product/development/pages/320-order-admin-center/index.md`
- 来源 Sitemap 行：
  - 生成顺序：320
  - 页面ID：M-500
  - 父页面ID：ROOT
...
- 当前输出文件：product/development/pages/320-order-admin-center/index-v2.md
- 页面级假设 / 待确认编号规则：
...
| S-003 | 销售趋势图表 | footer | 总是显示 | E-004 | 折线图/饼图展示 (JSON 驱动渲染) | API-003 |  |
...
| E-004 | 业务分析组件 | chart | S-003 | 是 | 总是显示 | 趋势图/占比图 | - | chart_data |  |
