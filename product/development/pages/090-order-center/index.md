...
- 当前输出文件：product/development/pages/090-order-center/index.md
...
|---|---|---|---|---|---|
| order_stats | object | API | {pending_pay:0, ...} | 卡片显示数字 |  |
...
|---|---|---|---|---|---|---|---|
| PA-001 | 订单中心主要展示“成交行为”，一旦订单进入“服务中”，后续进度建议引导至“我的服务”板块 | 1.1 页面目标 | 业务导向 | - | 高 | 确认 | 更新到正式 |

### 11.2 页面待确认清单

| 待确认ID | 待确认问题 | 首次出现位置 | 影响范围 | 影响元素 / Action / API / 埋点事件 | 优先级 | 用户确认结果 | Release 处理方式 |
|---|---|---|---|---|---|---|---|
| PQ-001 | 是否需要在此页面展示“待评价”或“服务完结”的统计？当前 MVP 侧重订单流转。 | 1.4 全局页面属性 | 统计范围 | E-001 | 低 | 确认 | 不需要 |
