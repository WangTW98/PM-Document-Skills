...
6. Load exactly one selected `design/<design-system>/` directory, starting with `DESIGN.md`.
7. Save the output to `product/release/design` with the same relative filename.
8. Include both natural language style description and AI-readable style structure.
9. Do not include interaction execution, analytics, API contracts, backend behavior, business logic, or implementation code.
