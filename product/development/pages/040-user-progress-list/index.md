...
- 来源 Sitemap 行：
  ...
  - 页面名称：进度查询列表
  - 页面类型：列表
  - Sitemap 页面级MD文件：product/development/pages/040-user-progress-list.md
- 当前输出文件：product/development/pages/040-user-progress-list/index.md
...
| E-007 | 案件数据表格 | list | S-003 | 是 | 有数据 | - | 8 列：案号、服务、公司、阶段、状态、时间、操作 | case_list | PA-001 |
...
|---|---|---|---|---|---|---|---|
| PA-001 | 表格默认按“更新时间”倒序排列，以展示最新变动的案件 | 4. 页面元素清单 | 数据排序 | E-007 | 高 | 确认 | 更新到正式 |

### 11.2 页面待确认清单

| 待确认ID | 待确认问题 | 首次出现位置 | 影响范围 | 影响元素 / Action / API / 埋点事件 | 优先级 | 用户确认结果 | Release 处理方式 |
|---|---|---|---|---|---|---|---|
| PQ-001 | 是否需要支持导出当前的案件进度列表（Excel）？ | 1.1 页面目标 | 功能范围 | 元素清单 | 低 | 确认 | 不支持 |
