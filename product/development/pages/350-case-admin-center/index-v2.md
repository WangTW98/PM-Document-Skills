...
- 来源主稿：`product/development/pages/350-case-admin-center/index.md`
- 来源 Sitemap 行：
  - 生成顺序：350
  - 页面ID：M-600
  - 父页面ID：ROOT
...
- 当前输出文件：product/development/pages/350-case-admin-center/index-v2.md
- 页面级假设 / 待确认编号规则：
...
| S-003 | 效能分析图表 | footer | 总是显示 | E-003, E-004 | 趋势图与排行榜 (JSON 驱动渲染) | API-003 |  |
...
| E-003 | 专家负荷排行 | chart | S-003 | 是 | 总是显示 | 柱状图 | - | load_rank |  |
| E-004 | 周期分析曲线 | chart | S-003 | 是 | 总是显示 | 趋势图 | - | cycle_chart |  |
...
| 埋点事件ID | 事件名称 | 事件类型 | 关联元素ID / ActionID | 触发时机 | 统计次数口径 | 去重规则 | 上报时机 | 关键属性 | 成功 / 失败归归因 | 漏斗阶段 | 相关 PA/PQ |
|---|---|---|---|---|---|---|---|---|---|---|---|
