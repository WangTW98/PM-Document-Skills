...
|---|---|---|---|---|---|---|---|
| S-001 | S-001 | 品牌展示区 | 建立第一视觉印象 | Logo、品牌欢迎文案及引导说明 | 静态 | | |
...
| E-002-1 | - | 引导文案 | text | S-001 | 未注册手机号验证后自动创建账户 | 静态 | | 14px, #666 | | | | |
...
| STATE-004 | E-001 | 默认 | 默认 | 页面首屏 | 欢迎使用 AI 简历优化 | | | | 静态 | |
...
|---|---|---|---|
| 品牌文案 | 欢迎使用 AI 简历优化、未注册手机号验证后自动创建账户 | | |
| 协议文案 | 我已阅读并同意《用户协议》和《隐私政策》 | | |
| 按钮文案 | 登录 / 注册、获取验证码 | | |
| 输入内容 | | 手机号、验证码 | 用户输入 |
| 状态反馈 | | 倒计时文字 | 系统状态 |
