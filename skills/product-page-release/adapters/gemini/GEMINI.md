...
7. Write exactly one release page to `product/release/pages` using the same relative filename.
8. Ensure the release document contains no `PA-*`, `PQ-*`, assumptions, open questions, or confirmation workflow sections.
