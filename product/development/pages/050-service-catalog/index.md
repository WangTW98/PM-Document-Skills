...
|---|---|---|---|---|---|---|---|
| PA-001 | 不同域名的平台品牌差异（Logo、色调）通过全局 CSS 变量或动态资源包实现，目录结构保持一致 | 1.4 全局页面属性 | 样式 | - | 高 | 待用户确认 |  |
| PA-002 | 商品主图在管理后台上传时需符合固定比例（如 4:3 或 1:1），以保证目录页布局整齐 | 10. 多媒体与资源 | 样式 | E-002 | 中 | 待用户确认 |  |

### 11.2 页面待确认清单

| 待确认ID | 待确认问题 | 首次出现位置 | 影响范围 | 影响元素 / Action / API / 埋点事件 | 优先级 | 用户确认结果 | Release 处理方式 |
|---|---|---|---|---|---|---|---|
| PQ-001 | 目录页是否需要展示“热门推荐”或“限时优惠”等特殊角标？ | 4. 页面元素清单 | 元素展示 | E-002 | 低 | 待用户确认 |  |
