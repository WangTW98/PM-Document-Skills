...
- 来源 Sitemap 行：
  ...
  - 页面名称：消息中心
  - 页面类型：列表
  - Sitemap 页面级MD文件：product/development/pages/180-message-center.md
- 当前输出文件：product/development/pages/180-message-center/index.md
...
| E-003 | 消息项卡片 | list | S-002 | 是 | 有数据 | - | - | message_list |  |
...
|---|---|---|---|---|---|---|---|
| PA-001 | 消息正文支持简单的 Markdown 渲染（如加粗案号、链接），以便在摘要中展示关键信息 | 4. 页面元素清单 | 数据展示 | E-003 | 中 | 确认 | 不需要 |

### 11.2 页面待确认清单

| 待确认ID | 待确认问题 | 首次出现位置 | 影响范围 | 影响元素 / Action / API / 埋点事件 | 优先级 | 用户确认结果 | Release 处理方式 |
|---|---|---|---|---|---|---|---|
| PQ-001 | 是否需要支持“消息删除”功能？当前假设仅支持已读/未读状态管理。 | 3. 页面布局 | 功能范围 | - | 低 | 确认 | 不需要 |
