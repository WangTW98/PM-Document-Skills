...
- 来源 Sitemap 行：
  ...
  - 页面名称：订单详情
  - 页面类型：详情
  - Sitemap 页面级MD文件：product/development/pages/110-order-detail.md
- 当前输出文件：product/development/pages/110-order-detail/index.md
...
|---|---|---|---|---|---|---|---|---|---|
| E-002 | 申请退款 | 状态="已支付" | can_refund | 描边样式 | 弹窗申请 | - | - | - | PQ-001 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| ACT-001 | E-002 | 申请退款 | 点击 | 订单已支付 | - | 弹窗确认原因并提交 | 状态变更为“退款中” | 错误提示 | - | EVT-002 | 退款申请点击 | - | PQ-001 |
...
| API-002 | 申请退款提交 | POST | /api/order/refund | ACT-001 | {order_id, reason} | {success} | 刷新状态 | 提示失败 | PQ-001 |
...
|---|---|---|---|---|---|---|---|
| PA-001 | 如果订单已关联案件且处于“处理中”状态，详情页将强制展示一个显眼的“查看服务进度”入口 | 3. 页面布局 | 交互引导 | E-007 | 高 | 确认 | 更新到正式 |

### 11.2 页面待确认清单

| 待确认ID | 待确认问题 | 首次出现位置 | 影响范围 | 影响元素 / Action / API / 埋点事件 | 优先级 | 用户确认结果 | Release 处理方式 |
|---|---|---|---|---|---|---|---|
| PQ-001 | 退款申请是否需要用户上传证明材料？当前 MVP 仅支持文本原因。 | 6. 交互 Action | 功能范围 | API-002 | 中 | 确认 | 不需要上传材料，仅已支付但后台未流转至服务中状态的订单支持退款 |
