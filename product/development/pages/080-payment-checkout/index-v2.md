...
- 来源主稿：`product/development/pages/080-payment-checkout/index.md`
- 来源 Sitemap 行：
  - 生成顺序：80
  - 页面ID：U-330
  - 父页面ID：U-320
...
- 当前输出文件：product/development/pages/080-payment-checkout/index-v2.md
- 页面级假设 / 待确认编号规则：
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| ACT-001 | - | 支付状态监听 | 自动触发 | 二维码显示后 | - | 建立 WebSocket 连接监听支付成功信号 | 支付成功 | 保持连接 / 失败回退轮询 | 跳转 U-420 | EVT-002 | 支付成功 | - |  |
...
| API-002 | 查询支付状态 (兜底) | GET | /api/pay/status | ACT-001 | {order_id} | {status} | 跳转成功页 | 保持监听 |  |
