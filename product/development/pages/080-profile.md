...
| E-004 | 列表入口项 | list | S-003 | 是 | 总是展示 | 历史简历、我的订单、在线客服 | 带箭头指示 | 无 | |
...
|---|---|---|---|---|---|---|---|
| PA-001 | 退出登录需进行二次确认弹窗 | 6. 交互 Action | 交互逻辑 | ACT-003 | 高 | 待用户确认 | 确认为正式内容 |

### 11.2 页面待确认清单

| 待确认ID | 待确认问题 | 首次出现位置 | 影响范围 | 影响元素 / Action / API / 埋点事件 | 优先级 | 用户确认结果 | Release 处理方式 |
|---|---|---|---|---|---|---|---|
| PQ-001 | 是否需要集成在线客服 SDK (如七鱼、美洽)？ | 4. 页面元素清单 | 功能模块 | E-004 | 中 | 待用户确认 | MVP 暂用跳转至关于页或说明 |
