...
- 当前输出文件：product/development/pages/200-agreements/index.md
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| ACT-001 | E-001 | 切换协议 | 点击 Tab | - | - | 刷新内容 | 协议内容变更 | - | - | - | - | 基础阅读不埋点 |  |
...
|---|---|---|---|---|---|---|---|
| PA-001 | 该页提供浏览器标准的打印适配（CSS Media Print），不提供单独的服务器端 PDF 生成功能 | 2. 页面结构 | 交互 | - | 高 | 确认 | 不需要，仅做展示功能 |

### 11.2 页面待确认清单

| 待确认ID | 待确认问题 | 首次出现位置 | 影响范围 | 影响元素 / Action / API / 埋点事件 | 优先级 | 用户确认结果 | Release 处理方式 |
|---|---|---|---|---|---|---|---|
| PQ-001 | 是否需要记录用户“已阅读该协议”的日志（用于法务审计）？当前假设仅作为展示。 | 1.1 页面目标 | 埋点/后台 | - | 中 | 确认 | 不需要 |
