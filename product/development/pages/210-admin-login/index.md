...
|---|---|---|---|---|---|---|---|
| PA-001 | 后台管理端强制要求 MFA 二步验证（如 Google Authenticator 或短信），作为等保要求 | 2. 页面结构 | 安全流程 | E-006, API-002 | 高 | 待用户确认 |  |
| PA-002 | 后台不提供自助注册功能，所有账号由超级管理员在系统中手动创建 | 1.1 页面目标 | 功能范围 | - | 高 | 待用户确认 |  |

### 11.2 页面待确认清单

| 待确认ID | 待确认问题 | 首次出现位置 | 影响范围 | 影响元素 / Action / API / 埋点事件 | 优先级 | 用户确认结果 | Release 处理方式 |
|---|---|---|---|---|---|---|---|
| PQ-001 | 是否需要支持“域账号登录 (SSO)”？当前 MVP 仅支持独立账号体系。 | 1.4 全局页面属性 | 登录方式 | - | 中 | 待用户确认 |  |
