...
4. Load `product/development/product-overview-draft.md`.
...
7. Write `product/release/product-overview-release.md` only when all material assumptions, confirmations, and supplement instructions have concrete release handling.
