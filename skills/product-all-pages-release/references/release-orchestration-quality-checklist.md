...
- Each release page path was derived from the canonical `页面级MD文件` by replacing `product/development/pages` with `product/release/pages`; version suffixes were not carried into release filenames.
