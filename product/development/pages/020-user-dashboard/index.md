...
- 当前输出文件：product/development/pages/020-user-dashboard/index.md
- 页面级假设 / 待确认编号规则：
...
|---|---|---|---|---|---|
| current_company_id | string | global store | first company | 数据统计范围 | 用户所属公司（支持多公司切换，PQ-001） |
...
| E-003 | 待办提醒区块 | card | S-002 | 是 | 总是显示 | 待办事项 (数量) | 带阴影卡片 | todo_count |  |
...
|---|---|---|---|---|---|---|---|---|---|
| E-003 | 告警状态 | 存在高风险待办 | todo_level="high" | 红色徽标/描边 | 点击查看 | - | 存在 {n} 项紧急待办 | 待办处理完成 | PA-001 |
...
|---|---|---|---|---|---|---|---|
| PA-001 | 待办提醒卡片在存在“高风险”或“即将到期”项时，通过红色徽标进行视觉强调 | 5. 元素状态矩阵 | 样式 | E-003 | 高 | 确认 | 添加红色徽标进行视觉强调 |

### 11.2 页面待确认清单

| 待确认ID | 待确认问题 | 首次出现位置 | 影响范围 | 影响元素 / Action / API / 埋点事件 | 优先级 | 用户确认结果 | Release 处理方式 |
|---|---|---|---|---|---|---|---|
| PQ-001 | 是否需要支持多公司切换概览？当前默认展示该账号下关联的全部或首个公司。 | 1.4 全局页面属性 | 数据模型 | API-001 | 中 | 确认 | 不需要，公司仅作为数据元素进行展示，不需要进行切换 |
