...
- `product/release/pages/<canonical-page-filename>.md`
...
- `product/release/pages/<canonical-page-filename>.release-blockers.md`
...
7. Save and verify.
   ...
   - Preserve the input page filename relative to `product/development/pages`, but strip a trailing draft revision suffix like `-v2` or `-v3` from the release filename.
