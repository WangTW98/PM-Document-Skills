...
- The target application form was determined from the user's instruction, or inferred from `product/release/product-sitemap-release.md` plus the selected page MD.
