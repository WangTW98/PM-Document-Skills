...
- User supplement changes are reflected consistently in product overview, sitemap table, Mermaid hierarchy, surface tree, page generation queue, dependencies, roles, permissions, and business rules when those areas are affected.
