...
| ActionID | 触发元素ID | 交互名称 | 用户动作 | 前置条件 | 校验规则 | 执行动作 | 成功结果 | 失败结果 | 页面跳转 / 状态变化 | 埋点事件ID | 埋点事件名称 | 相关 PA/PQ |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| ACT-001 | E-001 |  | 点击 / 输入 / 选择 / 拖拽 / 上传 / 长按 / 滑动 / 播放 / 暂停 |  |  | 本地状态更新 / API 调用 / 导航 / 打开弹窗 / 触发系统能力 |  |  |  | EVT-001 |  |  |
